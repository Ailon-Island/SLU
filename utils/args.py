...
def add_argument_base(arg_parser):
    ...
    #### BERT Hyperparams ####
    arg_parser.add_argument('--bert_train', action='store_true', help='whether to train BERT')
    arg_parser.add_argument('--bert_lr', type=float, default=1e-4, help='learning rate')
